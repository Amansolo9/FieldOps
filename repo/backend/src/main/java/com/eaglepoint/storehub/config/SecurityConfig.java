...
import com.eaglepoint.storehub.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Route-level rules provide defense-in-depth; method-level @PreAuthorize is the
            // primary authorization mechanism on individual controller methods.
